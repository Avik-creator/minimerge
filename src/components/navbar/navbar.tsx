    ...
    <div className="w-[100%] flex px-5 py-3 justify-between items-center">
      <div className="flex gap-2 justify-center items-center cursor-pointer">
        ...
        >
          ...
          <h1 className="text-xl font-[800]">Minimerge</h1>
        </div>
                      ...
                      >
                        <div className="flex items-center gap-1">
                          <img
                            width="20"
                            height="20"
                            src="https://img.icons8.com/ios-glyphs/30/analytics.png"
                            alt="analytics"
                          />
                      ...
                      >
                        <div className="flex items-center gap-1">
                          <img
                            width="20"
                            height="20"
                            src="https://img.icons8.com/pastel-glyph/64/qr-code--v2.png"
                            alt="qr-code--v2"
                          />
                          <span className="font-bold text-[.8rem]">
                            QR Codes
                      ...
                      >
                        <div className="flex items-center gap-1">
                          <img
                            width="20"
                            height="20"
                            src="https://img.icons8.com/ios-filled/50/lock.png"
                            alt="lock"
                          />
                          <span className="font-bold text-[.8rem]">
                            Private Links
