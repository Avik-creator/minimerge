    ...
    <div className="main overflow-x-hidden flex flex-col items-center justify-start">
      ...
      <div className="mt-[4rem] px-4 w-[100vw] h-[calc(100vh-4rem)] flex flex-col items-center pt-20 text-">
        <div className="flex flex-col items-center justify-center">
          <h1 className="font-bold md:text-5xl text-4xl">Free QR Code</h1>
          <h1 className="font-bold text-4xl">Generator</h1>
        ...
        <div className="mt-10 flex items-center justify-center gap-4">
          ...
          {/* <Button
            className="flex items-center justify-between px-2 bg-white hover:bg-white border border-black"
